...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/:alias',['controller' => 'Links', 'action' => 'view'],['pass' => ['alias'], '_name' => 'short']);

    $routes->connect('/jhgfdt/:alias',['controller' => 'Links', 'action' => 'page2nd'],['pass' => ['alias']]);
    $routes->connect('/oiuyty/:alias',['controller' => 'Links', 'action' => 'page3rd'],['pass' => ['alias']]);
    $routes->connect('/lkopiu/:alias',['controller' => 'Links', 'action' => 'page4th'],['pass' => ['alias']]);
    $routes->connect('/kuytyu/:alias',['controller' => 'Links', 'action' => 'page5th'],['pass' => ['alias']]);
});

// api 
Router::scope('/api', function (RouteBuilder $routes) {
    $routes->connect('/ads_update', ['controller' => 'Api', 'action' => 'adsaupdate']);
});
